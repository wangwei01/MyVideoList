                ...
                case AppConstant.WHAT.SUCCESS:
                    ...
                    mRecyclerView.addOnItemTouchListener(new OnItemClickListener() {
                        ...
                        public void SimpleOnItemClick(final BaseQuickAdapter adapter, View view, final int position) {
                            Toast.makeText(context, "video_path====" + ((List<Video>) adapter.getData()).get(position).getPath(), Toast.LENGTH_LONG).show();
                            PlayVideoActivity.start(SelectVideoActivity.this,((List<Video>) adapter.getData()).get(position).getPath());
                        }
                    });
